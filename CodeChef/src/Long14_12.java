		...
		for (int n = 1; n <= 14; n++) {
			for (int k = 1; k <= 8; k++) {
				for (int i = 0; i < 100; i++) {
					...
					String res = Long14_12.sanskar9(n, k, new ArrayList<Long>(a));
					//String res2 = sanskar3(n, k, a);
					String res2 = "";
					//res2 = Main.sanskar8(n, k, b);
					//try {
					res2 = Long14_12.sanskar8(n, k, new ArrayList<Long>(a));
					time = (System.nanoTime() - time)/1000000;
					//if (time >= 100) {
					if (!res.equals(res2)) {
					//if (res.equals("yes")) {
						Long14_12.sanskar8(n, k, new ArrayList<Long>(a));
		...
		for (int n = 1; n <= 21; n++) {
			for (int k = 1; k <= 8; k++) {
				for (int i = 0; i < 100; i++) {
					...
					long time = System.nanoTime();
					String res = Long14_12.sanskar9(n, k, b);
					time = (System.nanoTime() - time)/1000000;
					if (time >= 100) {
