...
public class NetworkXOneTimePadTest {
    ...
    public void testCase4() {
        String[] plaintexts = new String[]{ "00000000000000000000000000000000000000000000000000"};
        String[] ciphertexts = new String[]{"00000000000000000000000000000000000000000000000000"};
