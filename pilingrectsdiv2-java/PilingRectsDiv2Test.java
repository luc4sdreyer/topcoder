...
public class PilingRectsDiv2Test {
    ...
    public void testCase0() {
        ...
        Assert.assertEquals(4, solution.getmax(X, Y, 1));
        Assert.assertEquals(4, solution.getmax(X, Y, 2));
        Assert.assertEquals(3, solution.getmax(X, Y, 3));
        Assert.assertEquals(2, solution.getmax(X, Y, 4));
        Assert.assertEquals(1, solution.getmax(X, Y, 5));
        Assert.assertEquals(1, solution.getmax(X, Y, 6));
        Assert.assertEquals(1, solution.getmax(X, Y, 7));
        Assert.assertEquals(1, solution.getmax(X, Y, 8));
        Assert.assertEquals(1, solution.getmax(X, Y, 9));
        Assert.assertEquals(1, solution.getmax(X, Y, 10));
        Assert.assertEquals(1, solution.getmax(X, Y, 11));
        Assert.assertEquals(1, solution.getmax(X, Y, 12));
        Assert.assertEquals(-1, solution.getmax(X, Y, 13));
    }
